...
class AddUser extends JInternalFrame implements ActionListener
{
	...
	{
		//super("Add New user ");
		super("Add new user ",false,true,false,true);
		setFrameIcon(new ImageIcon("images/Add16.gif"));
		setSize(350,320);
		setLocation(450,50);		       setLayout(null);
