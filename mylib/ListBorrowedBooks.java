...
public class ListBorrowedBooks extends JInternalFrame
{
	...
	private static final String DEFAULT_QUERY = "SELECT BookID, Subject, Language, Title, Version, Author, Publisher, Copyright, Edition, Pages FROM Books WHERE Status='borrowed'";
