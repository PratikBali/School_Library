...
public class ListAvailableBooks extends JInternalFrame
{
	...
	private static final String DEFAULT_QUERY = "SELECT BookID, Subject, Language, Title, Version, Author, Publisher, Copyright, Edition, Pages,	NumberOfBooks FROM Books WHERE NumberOfBooks>0";

	//constructor of listAvailbleBooks
	public ListAvailableBooks()
	{
		//for setting the title for the internal frame
		super("Available Books", false, true, true, true);
