...
public class EditBooks extends JFrame implements ActionListener
{
	...
	public EditBooks()
	{
		...
		//seinformationTextFieldrameIcon(new ImageIcon(ClassLoader.getSystemResource("images/Edit16.gif")));
		...
		try
		{
			if(ae.getSource()==editButton)
			{
				...
				if (isEditCorrect())
				{
					...
					rs=stm.executeQuery("select * from  Books WHERE BookID ='" + editTextField.getText() +"'");
					while(rs.next())
					{
