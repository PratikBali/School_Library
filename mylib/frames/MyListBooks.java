 ...
 *A public class
 */
public class MyListBooks extends JFrame
 {
	/***************************************************************************
	...
	private static final String DATABASE_URL = "jdbc:odbc:library";
	...
	public MyListBooks()
	{
		...
		northLabel.setFont(new Font("Comic sans ms", Font.BOLD, 14));
