...
public class PrintingBooks extends JFrame implements Printable
{
	/***************************************************************************
	...
	public PrintingBooks(String query) {
		...
		try
		{
			connection = DriverManager.getConnection("jdbc:mysql:///library","root","");
			statement = connection.createStatement();
			resultset = statement.executeQuery(query);
			textArea.append("=============== Books Information ===============\n\n");
			//Subject, Title, Version, Author, Publisher, Copyright, Edition,
